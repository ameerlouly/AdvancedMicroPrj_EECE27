...
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/IF_ID_EN
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/Flush
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/PC_Plus_1_In
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/Instruction_In
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/immby
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/IP
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/PC_Plus_1_Out
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/Instruction_Out
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/immbyout
add wave -noupdate -group IF_ID /tb_CPU_FormatA_B/uut/if_id_reg_inst/IP_out
...
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/pc_plus1
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/RegDistidx
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/Rd2
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/ALU_res
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/data_B
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/MemToReg
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/RegWrite
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/IP
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/IO_Write
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/pc_plus1_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/RegDistidx_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/Rd2_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/ALU_res_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/data_B_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/MemToReg_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/RegWrite_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/IP_out
add wave -noupdate -expand -group MEM-WB /tb_CPU_FormatA_B/uut/mem_wb_reg_inst/IO_Write_out
...
add wave -noupdate -expand -group BU /tb_CPU_FormatA_B/uut/branch_inst/flag_mask
add wave -noupdate -expand -group BU /tb_CPU_FormatA_B/uut/branch_inst/BTYPE
add wave -noupdate -expand -group BU /tb_CPU_FormatA_B/uut/branch_inst/PC_SRC
add wave -noupdate -expand -group BU /tb_CPU_FormatA_B/uut/branch_inst/B_TAKE
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/d0
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/d1
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/d2
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/d3
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/sel
add wave -noupdate -expand -group PC_MUX /tb_CPU_FormatA_B/uut/PC_MUX/out
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/if_id_ra
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/if_id_rb
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/id_ex_rd
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/id_ex_mem_read
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/BT
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/pc_en
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/if_id_en
add wave -noupdate -expand -group HU /tb_CPU_FormatA_B/uut/hu_inst/flush
