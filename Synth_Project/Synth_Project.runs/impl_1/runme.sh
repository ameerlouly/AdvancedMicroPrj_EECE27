...
HD_PWD='D:/AdvancedMicroPrj_EECE27/Synth_Project/Synth_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_WrapperV3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_WrapperV3.tcl -notrace
