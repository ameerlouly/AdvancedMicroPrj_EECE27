...
HD_PWD='D:/AdvancedMicroPrj_EECE27/Synth_Project/Synth_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_WrapperV3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_WrapperV3.tcl
